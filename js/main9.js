...
GameState.prototype.create = function() {
    ...
    this.gun.scale.x = 0.05;
    this.gun.scale.y = 0.05;

    var pig = game.add.sprite(500,380,'pig');
    pig.scale.x = 0.05;
    pig.scale.y = 0.05;
    ...
    game.physics.arcade.collide(bullet,pig);
    game.physics.arcade.overlap(bullet,pig,crash,null,this);
